      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 max-w-2xl mx-auto">
          {stats.map((stat, index) => (
            ...
            index < 2 && (
            <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-blue-100 mb-8 text-lg leading-relaxed">
                Jelajahi berbagai UMKM di Bugel, Salatiga dari berbagai kategori industri. 
                Temukan produk dan layanan berkualitas dari usaha lokal terpercaya.
              </p>
            </div>

            <div className="relative">
              {/* TODO: Replace this URL with local image from public/images/landing/ */}
              {/* Place a business/data related image in public/images/landing/database-section.jpg */}
              <img
                src="https://images.pexels.com/photos/3184639/pexels-photo-3184639.jpeg"
                alt="Database UMKM"
                className="rounded-2xl shadow-2xl w-full h-80 object-cover"
              />
              <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl opacity-30"></div>
            </div>
          </div>
        </div>
      </div>
